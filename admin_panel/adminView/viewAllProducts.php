  ...
  <table class="table ">
    <thead>
      <tr>
        ...
        <th class="text-center">Unit Price discount</th>
        ...
        <div class="modal-body">
          <form enctype='multipart/form-data' onsubmit="addItems()" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="dis_price" name="dis_price" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-secondary" id="upload" name="upload" style="height:40px">Add
                Item</button>
            </div>
          </form>
