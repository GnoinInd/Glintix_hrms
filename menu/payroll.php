                ...
                <div class="home-demo">
                    <div class="row">
                        <div class="large-12 columns">
                            <h3>How does an integrated HR and Payroll software- Glintix work?</h3>
                ...
                <div class="row">
                    ...
                    <div class="col ">
                        <div class="card m-2 card_shadows" style="width: 100%; ">
                            <div class="card-body">
                                <h5 class="card-title mt-0 text-success fw-700 text-center">Heading</h5>
                                <!-- <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6> -->
                                <p class="card-text">Some quick example text to build on the card title and make up the
                                    bulk of the card's content.Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                    Aspernatur, vitae quia rem facilis
                                    totam laboriosam sit saepe consequuntur nisi soluta quas eaque ipsam enim expedita!
                                    Eveniet
                                    ex
                                    nisi sequi ipsum.</p>
                                <a href="#" class="card-link">Card link</a>
                            ...
                            <div class="card m-2 card_shadows" style="width: 100%;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                        Aspernatur, vitae quia rem
                                        facilis
                                        totam laboriosam sit saepe consequuntur nisi soluta quas eaque ipsam enim
                                        expedita!
                                        Eveniet ex
                                        nisi sequi ipsum</p>
                                    <a href="#" class="card-link">Card link</a>
                                ...
                                <div class="card m-2 card_shadows" style="width: 100%;">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up the bulk of the card's contentLorem ipsum dolor sit amet, consectetur
                                            adipisicing elit. Aspernatur, vitae quia rem
                                            facilis
                                            totam laboriosam sit saepe consequuntur nisi soluta quas eaque ipsam enim
                                            expedita!
                                            Eveniet ex
                                        ...
                                        <div class="card m-2 card_shadows" style="width: 100%;">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">Some quick example text to build on the card title
                                                    ...
                                                    consectetur adipisicing elit. Aspernatur, vitae quia
                                                    rem facilis
                                                    totam laboriosam sit saepe consequuntur nisi soluta quas eaque ipsam
                                                    enim
                                                    expedita! Eveniet ex
                                                    nisi sequi ipsum.</p>
                                                <a href="#" class="card-link">Card link</a>
                                    ...
                                    <div class="col ">
                                        <div class="card m-2 card_shadows" style="width: 100%;">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">Some quick example text to build on the card title
                                                    and
                                                    make up the bulk of the card's contentLorem ipsum dolor sit amet,
                                                    consectetur adipisicing elit. Aspernatur, vitae quia
                                                    rem facilis
                                                    totam laboriosam sit saepe consequuntur nisi soluta quas eaque ipsam
                                                    enim
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col ">
                                            <div class="card m-2 card_shadows" style="width: 100%;">
                                                <div class="card-body">
                                                    <h5 class="card-title mt-0 text-success fw-700 text-center">Heading
                                                    </h5>
                                                    <!-- <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6> -->
                                                    <p class="card-text">Some quick example text to build on the card
                                                        title
                                                        and make up the bulk of the card's contentLorem ipsum dolor sit
                                                        amet, consectetur adipisicing elit. Aspernatur, vitae
                                                        quia rem facilis
                                                        totam laboriosam sit saepe consequuntur nisi soluta quas eaque
                                                        ipsam
                                                        enim
                                                        expedita! Eveniet ex
                                                        nisi sequi ipsum..</p>
