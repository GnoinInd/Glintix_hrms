...
<head>
    ...
    <link rel="stylesheet" href="stylenswrm.css">
...
<div class="container-fluid p-0 m-0 sticky-top">
  ...
  <div class="container mt-5">
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col text-center">
                <h1 class="fs-1 fw-bolder text-dark">Glintix Newsroom</h1>
                <p class="fs-4">A collection of the most recent media coverage, events, webinars and more</p>
            </div>
        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="container">
                                ...
                                <div class="row justify-content-center ">
                                    ...
                                    <div class="col-md-3 col-sm-6 text-center  border border-top-0"><img
                                            src="../images/logo-haier.jpg" alt=""></div>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h4 class="text-secondary">In the Spotlight</h4>
            </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        <div class="swiper mySwiper swiper1">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="slider-newsrm-img">
                                        <img src="../images/featured-people.svg" alt="" class="img-fluid">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="slider-newsrm-img">
                    ...
                    <div class="col-md-6">
                        <section class="myscroll" data-bs-spy="scroll" data-bs-offset="15"
                            data-bs-target="#myScrollspy">
                            <div class="container-lg my-2">

                                <div class="row">
                                    <div class="col">
                                        <h4 class="text-secondary fw-bold">In The News</h4>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 " style="height: 280px; overflow-y: scroll;">
                                        <div id="section1">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <img src="../images/../images/tennews.png" alt="" class="img-fluid">
                                                </div>
                                                <div class="col-md-9">
                                                    <p>Glintix breaks all engagement cliches with the new initiative for
                                                        world
                                                        of
                                                        work</p>
                                                </div>
            ...
            <div class="col-md-12">
                <div class="row mt-5">
                    <div class="col border-end">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link me-3 active" id="home-tab" data-bs-toggle="tab"
                                    data-bs-target="#home-tab-pane" type="button" role="tab"
                                    aria-controls="home-tab-pane" aria-selected="true">Home</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link ms-3 " id="profile-tab" data-bs-toggle="tab"
                            ...
                            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                ...
                                <div class="container mt-2">
                                    <div class="row">
                                        <div class="col p-0">
                                            <div class="newsrmimg ">
                                                <img src="../images/whc.jpg" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <h3>World HRD Congress</h3>
                                            <p>Date
                                                15th Feb – 17th Feb</p>
                                            <p>Venue
                                                Mumbai</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col p-0">
                                                    <div class="newsrmimg ">
                                                        <img src="../images/whc.jpg" alt="" class="">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <h3>World HRD Congress</h3>
                    ...
                    <div class="col text-center">
                        <h1 class="fw-bold ">Webinars</h1>

                        <img src="../images/newsroom_webinar.png" alt="" class="">
                    </div>
                </div>
            </div>

            <div class="col-md-12">
                <div class="row mt-5 bgk-color">
                    <div class="col mt-5 ms-3">
                        <h1 class="text-success">Join the 60,000+</h1>
                        <h1 class="text-white">Leaders Club.</h1>
                        <p class="text-white">Get the most relevant workplace <span class="bold">trends, tips, and
                                templates</span> delivered
                            to
                    ...
                    <div class="col mt-5">
                        <form class="row g-3">
                            <div class="col-auto">
                                ...
                                <input type="text" class="form-control" id="staticEmail2" placeholder="Enter Email ID*">
                            </div>

                            <div class="col-auto">
                                <button type="submit" class="btn btn-primary mb-3 bg-white text-dark">SUBSCRIBE</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-aliceblue mt-5 p-5">
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-4 ">
                    <div class="p-3 rounded m-2" style="background: #FEE5E1;">
                        <span class="fw-bold p-2">2 Dec 2022</span>
                        <p class="fs-4 ">“Asia Healthcare Holdings automates its HR Operations with Glintix</p>
                    </div>
