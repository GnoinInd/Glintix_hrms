    ...
    <div class="container mt-5">
        <div class="row">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <p>Glintix was incepted in 2016 with the vision to simplify and automate the HR functions
                            ...
                            actionable
                            insights to build better workplaces</p>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <img src="../images/ourstory_1.png" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="row mt-5">
                    <div class="col-md-5 col-sm-12">
                        <h4>Why Glintix makes sense</h4>
                        <p>Some frequently asked questions (FAQs) by companies that switch to Glintix</p>
                        <img src="../images/why_make_sense.png" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-7 col-sm-12 d-flex justify-content-center align-items-center">
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingminusone">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseminusone" aria-expanded="true"
                                        aria-controls="collapseminusone">
                                        How is Glintix different from other HRMS solutions?
                                    </button>
                                </h2>
                                <div id="collapseminusone" class="accordion-collapse collapse "
                                    aria-labelledby="headingminusone" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <ul>
                                            <li>We are India’s first <a target="_blank" href="#"
                                                    rel="noopener noreferrer">HRMS
                                                    company</a> that offers consumer centric
                                                experience in an enterprise HCM suite like Ola, Uber, Swiggy &amp;
                                                Amazon in the
                                                B2B space.</li>
                                            <li>Glintix not only just automates HR processes &amp; tasks but also gives
                                                your HR
                                                team the platform &amp; freedom to build happier and engaged workforce.
                                            </li>
                                            <li>Glintix further provides actionable insights unlike no other HRMS
                                                solution that
                                                helps you take decisions faster and achieve results making it one of the
                                                best <a target="_blank" href="#" rel="noopener noreferrer">HR
                                                    software</a> in the industry.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Can Glintix really improve the efficiency of HR department?
                                        </button>
                                    </h2>
                                    <div id="collapseOne" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Glintix lets you execute tasks, pull reports and respond to queries
                                                    all from
                                                    a
                                                    single window rather than navigating through confusing enterprize
                                                    solutions
                                                    with our innovative HR desk. </li>
                                                <li>Get instant response to any HR query using a Google like search that
                                                    helps
                                                    you save time and execute task on the fly.</li>
                                                <li>Empower your HR team to clear all pending tasks on behalf of
                                                    managers and
                                                    say goodbye to bottlenecks.</li>
                                                <li>40+ built-in imports that gives you freedom to upload bulk data
                                                    across
                                                    modules and avoid manual entries or backend data upload.</li>
                                                <li>Get dashboards &amp; frequently used reports straight to your email
                                                    inbox
                                                    without logging into the systems.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingTwo">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Is your Glintix suitable for companies with headcount of 100 employees?
                                            5000?
                                        </button>
                                    </h2>
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Glintix is scalable HR platform which can used by startup companies
                                                    as small
                                                    as 50 employees to large enterprises as big as 5000 employees
                                                    strong.
                                                    Glintix
                                                    also gives companies the flexibility to start with just core modules
                                                    and
                                                    then add other modules as you grow. So no matter your size, industry
                                                    or
                                                    complexity; Glintix has you covered.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <ul>
                                                <li>The Glintix mobile app is not just limited to employees but allows
                                                    your HR
                                                    team to execute day 2 day task from the comfort of their mobile
                                                    phones.</li>
                                                <li>Execute more than 50+ tasks in just few clicks on the go using <a
                                                        target="_blank" href="/mobile-app/"
                                                        rel="noopener noreferrer">Glintix
                                                        mobile app</a>.</li>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingfour">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            How much time does it takes to learn &amp; adopt Glintix?
                                        </button>
                                    </h2>
                                    <div id="collapsefour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <ul>
                                                <li>We have built an intelligent inbox that will auto assign tasks to
                                                    users as
                                                    per their role which is similar to your email inbox. Your learning
                                                    curve
                                                    ends in 01 day.</li>
                                                <li>One place to perform more than 50+ tasks from Glintix inbox. Example
                                                    generate
                                                    letters, solve employee grievance, assign goals &amp; target,
                                                    process loans
                                                    &amp; reimbursements and more.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingfive">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            What is the average implementation time for Glintix?
                                        </button>
                                    </h2>
                                    <div id="collapsefive" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <ul>
                                                <li>With over 350+ successful implementations, our unique implementation
                                                    methodology ensure that your system is up &amp; running between 5 to
                                                    25 days
                                                    depending on the company size.</li>
                                                <li>Our tried &amp; tested 4 steps collaborative implementation process
                                                    further
                                                    ensures error free policy configuration and facilitates quick user
                                                    onboarding unlike no other in the industry.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingsix">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Will I be dependent on you post implementation?
                                        </button>
                                    </h2>
                                    <div id="collapsesix" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Our collaborative implementation process ensures complete
                                                    transparency on
                                                    policy configuration so that the customer is never in the dark.</li>
                                                <li>We believe in giving more power to customer by providing complete
                                                    access of
                                                    product setup to enable them to make day 2 day configuration changes
                                                    on
                                                    their own.</li>
                                                <li>Our extensive free of cost product training course ensure that your
                                                    team is
                                                    Glintix certified to use the product efficiently.</li>
                                                <li>Get answers to any customer queries in less than 4 hours through our
                                                    centralized customer helpdesk.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingseven">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Can I measure the ROI of using Glintix?
                                        </button>
                                    </h2>
                                    <div id="collapseseven" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Get to know your return on investment (ROI) by analysing the product
                                                    usage
                                                    and man hours saved with the help of our intuitive ROI dashboard.
                                                </li>
                                                <li>Our &#8220;HR-Ops&#8221; dashboard help you to identify process that
                                                    are not
                                                    streamlined so that take necessary preventive actions and improve
                                                    employee
                                                    experience.</li>
                                                <li>Our extensive free of cost product training course ensure that your
                                                    team is
                                                    Glintix certified to use the product efficiently.</li>
                                                <li>Identify processes that are not configured in the system with the
                                                    help of
                                                    our Setup-Dashboard so that you can make optimal usage of Glintix.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="col-md-12">
                <div class="row mt-5 ">
                    <div class="col ">
                        <h4 class="text-center">Something for everyone</h4>
                        <p class="text-center">Learn how Glintix can make life easier & improve your efficiency</p>
                        <div class="about-image text-center">
                            <img src="../images/smthn_foreveryone.png" alt="" class="img-fluid w-50">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="nav nav-pills mb-3 " id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="true">HR Professionals</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-profile" type="button" role="tab"
                                    aria-controls="pills-profile" aria-selected="false">Employees</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-contact" type="button" role="tab"
                                    aria-controls="pills-contact" aria-selected="false">Managers</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-contact1" type="button" role="tab"
                                    aria-controls="pills-contact" aria-selected="false">CXO'S</button>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-12 d-flex justify-content-center">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <h4 class="text-success"> <span class="text-dark">For</span> HR Professionals
                                        </h4>
                                        Glintix lets you automate key HR processes and transactional HR tasks thereby
                                        helping
                                        your
                                        HR
                                        team
                                        improve efficiency and save time.<br>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <img src="../images/for_profess.png" alt="" class="img-fluid story__everyone">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <h4 class="text-success"> <span class="text-dark">For</span> Employees</h4>
                                        Give your employees an HR experience they truly deserve. Powerful ESS, robust
                                        helpdesk &
                                        intuitive HR bot to empower employees.<br>
                                    </div>
                                    <div class="col">
                                        <img src="../employee-banner.jpg" alt="" class="img-fluid story__everyone--img">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <h4 class="text-success"> <span class="text-dark">For</span> Managers</h4>
                                        Monitor and control team activities & request. Be a step ahead and improve team
                                        productivity
                                        with wide array of tools.<br>
                                    </div>
                                    <div class="col">
                                        <img src="../manager-banner.jpg" alt="" class="img-fluid story__everyone--img">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="pills-contact1" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <h4 class="text-success"> <span class="text-dark">For</span> CXOs</h4>
                                        Get a bird eye view of your organization with customized reports & dashboards
                                        and make
                                        informed decisions faster.<br>
                                    </div>
                                    <div class="col">
                                        <img src="../cxo-banner.jpg" alt="" class="img-fluid story__everyone--img">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="row mt-5">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <p>Switch to Glintix, an intelligent enterprise-ready HCM tool and best payroll software
                            empowering your
