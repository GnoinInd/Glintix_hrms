    ...
    <div class="row">
      ...
      <div class="col-md-12 d-flex justify-content-center">
        <div class="nav  nav-pills  " id="v-pills-tab" role="tablist" aria-orientation="vertical">
          <button class="nav-link active text-secondary border border-2 m-1 hr_prff_tabs " id="v-pills-home-tab"
          ...
          <button class="nav-link text-secondary border border-2 m-1 hr_prff_tabs " id="v-pills-profile-tab"
            data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab"
            aria-controls="v-pills-profile" aria-selected="false">Analytics</button>
          <button class="nav-link text-secondary border border-2 m-1 hr_prff_tabs " id="v-pills-messages-tab"
            data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab"
            aria-controls="v-pills-messages" aria-selected="false">Strong core</button>
          <button class="nav-link text-secondary border border-2 m-1 hr_prff_tabs " id="v-pills-settings-tab"
            data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab"
            aria-controls="v-pills-settings" aria-selected="false">Experience</button>


          <button class="nav-link text-secondary border border-2 m-1 hr_prff_tabs " id="v-pills-extra-tab1"
            data-bs-toggle="pill" data-bs-target="#v-pills-extra-tab1" type="button" role="tab"
            aria-controls="v-pills-extra-tab1" aria-selected="false">Experience1</button>

          <button class="nav-link text-secondary border border-2 m-1 hr_prff_tabs " id="v-pills-extra-tab2"
            data-bs-toggle="pill" data-bs-target="#v-pills-extra-tab2" type="button" role="tab"
            aria-controls="v-pills-extra-tab2" aria-selected="false">Experience2</button>

          <button class="nav-link text-secondary border border-2 m-1 hr_prff_tabs " id="v-pills-extra-tab3"
            data-bs-toggle="pill" data-bs-target="#v-pills-extra-tab3" type="button" role="tab"
            aria-controls="v-pills-extra-tab3" aria-selected="false">Experience3</button>
