...
<body>
  <div class="container-fluid p-0 m-0 sticky-top">
    ...
    <div class="container-fluid mt-5" style="background-color: #ecfcfa;">
        ...
        <div class="row p-4">
            <div class="col ">
                <p class="h-50">“Glintex allowed us to customize and create our HR workflows. Since it covers all the HR
                    core modules,
            ...
            <div class="col">
                <p class="h-50">“We are happy we chose Glintix. From supporting remote working to improving the overall
                    engagement
                    levels, Glintix has been creating a positive impact on our entire workforce. Truth be told, Glintix
                    is a
    ...
    <div class="container-fluid" style="background-color: #ecfcfa;">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12 text-center ">
                <div class="bg-white">
                    ...
                    <p>
                        The Referral Partner Program is for anyone who wants to grow their revenue without any
                        investment.
                        Whether your expertise is in sales, marketing, accounting, management consulting, or banking—If
                        you
        ...
        <footer>
            <div class="container">
                ...
                <div class="row mt-5">
                    <div class="col-md-4 ">
                        <a href="#" target="_blank" rel="noopener"><img src="../images/playstore.svg"
                                class="appstore__link" alt=" Glintix Inbox App on Google Play Store"></a>
                        <a href="#" target="_blank" rel="noopener"><img src="../images/appstore.svg"
                                class="appstore__link" alt="Glintix Inbox App on Apple App Store"></a>
                        <p class="mb-0 mt-2"><a href="#" target="_blank" class="social__link" rel="noopener"><img
                            ...
                            <a href="#" target="_blank" class="social__link" rel="noopener"><img
                                    src="../images/twitter.svg" alt="Glintix Twitter" class="social__icon"></a>
                        </p>
                    </div>
                    <div class="col-md-8">
                        <div class="row">
