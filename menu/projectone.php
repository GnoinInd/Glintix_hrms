...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="prjctoneImg">
                    <img src="projectone-banner.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-3 mb-3">
                <div class="prjctoneImg">
                    <img src="core-settings-icon.svg" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="prjctoneImg">
                    <img src="project-icon.svg" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="prjctoneImg">
                    <img src="log-hours-icon.svg" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="prjctoneImg">
                    <img src="tasks-icon.svg" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="prjctoneImg">
                    <img src="teams-icon.svg" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="prjctoneImg">
                    <img src="reports-icon.svg" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="prjctoneImg">
                    <img src="master-settings.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container" style="background-color: rgb(233, 231, 231);">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="prjctoneImg">
                    <img src="project-policy.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="prjctoneImg">
                    <img src="task.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="prjctoneImg">
                    <img src="operations.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="prjctoneImg">
                    <img src="timelog.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="prjctoneImg">
                    <img src="operations (1).png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
