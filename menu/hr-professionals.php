      ...
      <div class="col-md-12">
        <div class="row mt-3">
          <div class="col-md-6 col-sm-12">
            ...
            <button type="submit" class="btn btn-success">REQUEST A DEMO</button>
          </div>
          <div class="col-md-6 col-sm-12">
        ...
        <div class="tab-content" id="v-pills-tabContent">
          ...
          <div class="tab-pane fade" id="v-pills-extra-tab1" role="tabpanel" aria-labelledby="v-pills-extra-tab1">
            ...
            <div class="row text-center">
              ...
              <div class="col-md-5">
                <img src="images/database_product.png" alt="">
              </div>
            </div>
            ...
            <div class="modal-body">
              <form action="action.php">
                ...
                <div class="modal-footer justify-content-center">
                  <button type=" submit btn btn-primary " class="btn btn-primary ">Book a Demo</button>
                </div>
              </form>
            </div>
