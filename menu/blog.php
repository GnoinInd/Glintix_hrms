...
<div class="container-fluid p-0 m-0 sticky-top">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <form class="d-flex">
                    <button class="btn btn-success btn-custom btn-custom1  m-1 text-white fw-700" type="submit"><a href="/login.html"
                            class="text-white">Login</a></button>
                    <button class="btn btn-success btn-custom btn-custom1  m-1 text-white fw-700" type="submit m-1">Contact</button>
                </form>
            </div>
        </nav>
    </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12">
                ...
                <p class="text-secondary">Explore expert insights, tips, tools, and articles created to help businesses succeed.</p>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="card m-2" style="width: 100%;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, repudiandae. </p>
