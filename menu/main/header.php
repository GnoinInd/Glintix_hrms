                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12 p-0 text-center">
                                            <li><a class="dropdown-item" href="menu/hr-software.php">HR Software</a>
                                            </li>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <li><a class="dropdown-item" href="menu/workforce.php"> <img
                                                        src="images/workforceicon.png" alt=""> WorkForce</a></li>
                                            <li><a class="dropdown-item" href="menu/attendance-management-system.php">
                                                    <img src="images/attendanceicon.png" alt=""> Attendance</a></li>
                                            ...
                                            <li><a class="dropdown-item" href="menu/recruitment.php"> <img
                                                        src="images/recruitmnticon.png" alt=""> Recruitment</a></li>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <li><a class="dropdown-item" href="menu/engagement.php"> <img
                                                        src="images/engagementicon.png" alt=""> Engagement</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown_menu_show">
                        ...
                        <li><a class="dropdown-item" href="../menu/hr_commune.php"> HR
                                Commune </a></li>
                        <li><a class="dropdown-item" href="../menu/guides.php"> Guides </a>
                        </li>
                        ...
                        <li><a class="dropdown-item" href="../menu/checklist.php"> Checklist
                            </a></li>
