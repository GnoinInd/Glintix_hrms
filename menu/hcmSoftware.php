...
<div class="container-fluid p-0 m-0 sticky-top">
  ...
  <div class="container mt-5">
    ...
    <div class="container-fluid bg-aliceblue mt-5 ">
        <div class="row ">
            <div class="col text-center">
                <h4>Glintix HRIS software- One best solution for all HR tasks.</h4>
                <p>Effortlessly map your Org structure on Glintix, no matter what size your
                    Workforce is or how diverse the functions and policies are.</p>
            </div>
        </div>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col">
                <h3>Our Clients See Value in it, Yours Will Too</h3>
                <p>“Glintix allowed us to create customised workflows. Since it covers all the HR core modules, we could
                    carry out every HR operation effectively while working from home.”</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-11 col-sm-12">
                        <div class="hcmEmdetail ">
                            <h5>Mr. Tanay Chothani</h5>
                            <h6>CEO, TravelXP</h6>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-blueclr mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mt-4 ">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item " role="presentation">
                            <button class="nav-link  active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                                type="button" role="tab" aria-controls="home" aria-selected="true">Core HR</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                                type="button" role="tab" aria-controls="profile" aria-selected="false">Glintix CoreHR</button>
                        </li>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingfour">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            How HROne HRIS software helps with employee empowerment?
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingfive">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            What are some of the advantages of HROne HRIS software?
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingsix">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            How is HROne better than other HRIS? 
                                        </button>
                                    </h2>
