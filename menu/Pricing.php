...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-6 col-sm-12">
        <h3>
          Join the hundreds of companies building amazing workplaces with Glintix!
        </h3>
        <p>Powerful, comprehensive & yet the most affordable HR software you can buy without breaking your bank.
        </p>
      </div>
      <div class="col-md-6 col-sm-12">
        <h3>
        ...
        <p>No matter how Big or Small you are;
          we have a plan that’s right for your business.</p>
        ...
        <div class="row">
          ...
          <div class="modal-footer justify-content-center">
            <button type="submit " class="btn btn-success btn-custom ">Book a Demo</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-3 ">
        <div class="card" style="width: 100%; height: 100%;">
          <div class="card-body">
            <h5 class="card-title"> Core HR</h5>
            <h6 class="card-subtitle mb-2 text-muted">Features</h6>
            <p class="card-text">
            <ul>
              <li>Create Org structure (multi-company configurations)</li>
              <li>Create Role as per your company</li>
              <li>Grant access rights (3 layers)</li>
              <li>Page access</li>
              <li>Action access</li>
              <li>Data access visibility</li>
              <li>Employee database</li>
              <li>Announcement (text, rich media, video)</li>
              <li>HR Handbook (HR policies, Forms, Videos)</li>
              <li>HR Post</li>
              <li>Generate general letters</li>
            </ul>
            </p>
          </div>
      ...
      <div class="col-md-3 ">
        <div class="card" style="width: 100%; height: 100%;">
          <div class="card-body">
            ...
            <p class="card-text">
            <ul>
              <li>Auto shift (shift rotations policy)</li>
              <li>Multi Holiday calendar (locations)</li>
              <li>Manage attendance</li>
              <li>Overtime & Comp-off</li>
              <li>Manage Leaves - auto leave credit</li>
              <li>Auto attendance arrears</li>
              <li>Auto attendance process (schedule auto attendance)</li>
              <li>Geo-tagging, geo-fencing</li>
      ...
      <div class="col-md-3 ">
        <div class="card" style="width: 100%; height: 100%;">
          <div class="card-body">
            ...
            <p class="card-text">
            <ul>
              <li>Manage mutiple pay groups</li>
              <li>Auto CTC breakups</li>
              <li>Process Salary</li>
              <li>Increment & Attendance arrears</li>
              <li>Reimbursements</li>
              <li>Income tax, Investment Declaration</li>
  ...
  <div class="container ">
    <div class="row ">
      <div class="col">
        <h4>2. Add Ons</h4>
        <p>Supplement your Glintix base packs with powerful add-ons of your choice</p>
      </div>
    </div>

    <div class="row">
      <div class="col-md-4 col-sm-12 text-center ">
        <img src="../images/workforce.png" alt="">
      </div>
      <div class="col-md-4 col-sm-12 text-center">
