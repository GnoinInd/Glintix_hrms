    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <li><a class="dropdown-item" href="../menu/expense.php"> <img src="../images/expenseicon.png"
                                alt=""> Expense</a></li>
                          <li><a class="dropdown-item" href="../menu/asset.php"> <img src="../images/asseticon.png"
                                alt=""> Asset</a></li>
                        </div>
                      </div>
                    </div>
        ...
        <form class="d-flex">
          ...
          <button class="btn btn-success btn-custom1  m-1 text-white fw-700" href="contact.php" type="submit m-1"><a
              href="contact.php" class="text-white">Contact</a></button>
        </form>
      </div>
    </nav>
  </div>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="row justify-content-center">
          ...
          <div class="col-md-3 col-sm-12">
            <button class="btn btn-success btn-custom text-start">GET DEMO</button>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="mob-app-img">
          <img src="../images/mobileApp-perform-min.png" alt="" class="img-fluid">
        </div>
    ...
    <div class="row">
      ...
      <div class="text-center">
        <button class="btn btn-success btn-custom w-25 text-center">REQUEST A DEMO</button>
      </div>
    </div>
