...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="hlpdk">
                    <img src="img/helpdesk-banner.jpg" alt="" class="img-fluid">
                </div>
            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-3 col-sm-12 text-center">
                                <div class="hlpdsk-logo">
                                    <img src="img/ticket-creation.svg" alt="" class="img-fluid">
                                </div>
                                <p>Ticket Creation</p>
                            </div>
                            <div class="col-md-3 col-sm-12 text-center">
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="hlpdk">
                            <img src="img/ticket-policy-min.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="hlpdk">
                            <img src="img/ticket-resolution-min.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="hlpdk">
                            <img src="img/agent-review-min.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="hlpdk">
                            <img src="img/insights-ticket-min.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
