    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-12 mt-5 text-center">
                <div class="row ">
                    <div class="col-md-12">
                        <h4>HROne workforce management software for every hire to retire core operational task!</h4>
                    </div>
                    <div class="col-md-12">
                        <p>Take control of your employee’s experience at each stage of the journey, like how you do it
