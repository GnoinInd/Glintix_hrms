    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="row mt-5">
                    <div class="col">
                        ...
                        <a href="#"><img src="core-hr.png" alt=""> Core HR</a>
                    </div>
                    <div class="col">
                        <a href="#"><img src="workforce.png" alt=""> Workforce</a>
                    </div>
                    <div class="col">
                        <a href="#"><img src="payroll.png" alt=""> Payroll</a>
                    </div>
                    <div class="col">
                        <a href="#"><img src="time-office.png" alt=""> Time office</a>
                    </div>
                    <div class="col">
                        <a href="#"><img src="performance.png" alt=""> Performance</a>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col">
                        ...
                        <a href="#"><img src="helpdesk.png" alt=""> Helpdesk</a>
                    </div>
                    <div class="col">
                        <a href="#"><img src="expense.png" alt="">Expense</a>
                    </div>
                    <div class="col">
                        <a href="#"><img src="recruitment.png" alt=""> Recruitment</a>
                    </div>
                    <div class="col">
                        <a href="#"><img src="asset.png" alt=""> Asset</a>
                    </div>
                    <div class="col">
                        <a href="#"><img src="engagement.png" alt=""> Engagement</a>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="row mt-4">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="hr-soft-img">
                            <img src="core-hr-min.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="row mt-4">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="row">
                            <div class="col"> <a href="#"><img src="imports.svg" alt=""> 10+ imports</a></div>
                            <div class="col"><a href="#"><img src="reports.svg" alt=""> 15+ reports</a></div>
                            <div class="col"><a href="#"><img src="dashboard.svg" style="width: 25%;" alt="">
                                    Dashboards</a>
                            </div>
                            <div class="col"><a href="#"><img src="processes.svg" style="width: 25%;" alt=""> 12+
                                    Processes</a>
                            </div>
                            <div class="col-md-6 col-sm-12 text-center text-start">
                                <ul>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="hr-soft-img">
                            <img src="workforce-min.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="row mt-4">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="hr-soft-img">
                            <img src="payroll-min.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="row mt-4">
                    <div class="col-md-6 col-sm-12">
                        <a href="#"><img src="time-office.png" alt=""> Attendance</a>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="hr-soft-img">
                            <img src="attendance-min.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="hr-soft-img1 text-center">
                            <img src="mobile-app-convenience-min.png" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col">
                        <div class="hr-soft-img">
                            <img src="hr-software-integrations-min.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="container">
                                    <div class="row">
                                        <div class="col">
                                            <div class="hr-soft-img text-center">
                                                <img src="enhanced-information.svg" alt="" class="img-fluid ">
                                            </div>
                                            <h3 class="text-success text-center">Structured Administration and Less
                                                Paperwork</h3>
                                            <p class="text-dark">
                            ...
                            <div class="swiper-slide">
                                <div class="container">
                                    <div class="row">
                                        <div class="col">
                                            <div class="hr-soft-img text-center">
                                                <img src="seamlessly-icon.png" alt="" class="img-fluid ">
                                            </div>
                                            <h3 class="text-success text-center">Structured Administration and Less
                                                Paperwork</h3>
                                            <p class="text-dark">
                            ...
                            <div class="swiper-slide">
                                <div class="container">
                                    <div class="row">
                                        <div class="col">
                                            <div class="hr-soft-img text-center">
                                                <img src="enhanced-employee.svg" alt="" class="img-fluid ">
                                            </div>
                                            <h3 class="text-success text-center">Structured Administration and Less
                                                Paperwork</h3>
                                            <p class="text-dark">
                            ...
                            <div class="swiper-slide">
                                <div class="container">
                                    <div class="row">
                                        <div class="col">
                                            <div class="hr-soft-img text-center">
                                                <img src="improved-decision.svg" alt="" class="img-fluid ">
                                            </div>
                                            <h3 class="text-success text-center">Structured Administration and Less
                                                Paperwork</h3>
                                            <p class="text-dark">
                            ...
                            <div class="swiper-slide">
                                <div class="container">
                                    <div class="row">
                                        <div class="col">
                                            <div class="hr-soft-img text-center">
                                                <img src="compliance-employment.svg" alt="" class="img-fluid ">
                                            </div>
                                            <h3 class="text-success text-center">Structured Administration and Less
                                                Paperwork</h3>
                                            <p class="text-dark">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center ">
                ...
                <div class="col-md-3 col-sm-6 text-center  border border-top-0"><img src="logo-bikaner.jpg" alt="">
                </div>
            ...
            <div class="row justify-content-center ">
                ...
                <div class="col-md-3 col-sm-6 text-center  border border-end-0"><img src="logo-harvest.jpg" alt="">
                </div>
            </div>
            <div class="row justify-content-center ">
                <div class="col-md-3 col-sm-6 text-center  border border-start-0"> <img src="kyocera.png" alt=""> </div>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="hr-soft-img">
                        <img src="map-location.png" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <h3>HRMS Systems
            ...
            <div class="row">
                <div class="col text-center">
                    ...
                    <div class="text-center mt-4 pb-5">
                        <button class="btn btn-success"> GET FREE DEMO</button>
                    </div>
                </div>
            </div>
        </div>
